...
/// </summary>
public static class TvBundleAuth
{
    // Token de la Fase 1. Rotarlo = rebuild de player + actualizar el secret del Worker.
    private const string FallbackToken = "aqtv_TOKEN_FUERA_DE_GIT";
